    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_currency', models.CharField(choices=[('CLP', 'Peso Chileno'), ('USD', 'Dolar'), ('EUR', 'Euro'), ('GBP', 'Libra'), ('JPY', 'Yen'), ('BRL', 'Real'), ('MXN', 'Peso Mexicano'), ('INR', 'Rupee'), ('CNY', 'Yuan'), ('CAD', 'Dolar Canadiense'), ('AUD', 'Dolar Australiano')], max_length=3)),
                ...
                ('cover_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_cover_image', to='core.image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.DecimalField(decimal_places=1, default=0, max_digits=2)),
                ('embedding', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(), blank=True, null=True, size=384)),
                ('cover_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='event_cover_image', to='core.image')),
                ('organization_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organizations.organization')),
                ('place_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='location.place')),
            ],
        ),
